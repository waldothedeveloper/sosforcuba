...
const Section5_Human_Rights = () => {
  return (
    <div className="space-y-12 mt-32 prose prose-blue prose-lg text-gray-300 mx-auto max-w-4xl">
      ...
      <p>
        There are over 17 human rights violations by the communist government of
        Cuba. They started after 1959 and for 62 years have not stopped.
      </p>
      ...
      <p>
        ...
        history of repression, beatings, public shaming acts, harassment, fines,
