...
const Protests = () => {
  ...
  return (
    <>
      <Layout>
        <Seo
          title="S.O.S. Cuba. Join the chant for freedom."
          description="The people of Cuba have finally awakened. Here you will find an updated list of all protests and rallies for the freedom of Cuba."
        >
