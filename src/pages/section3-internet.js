...
const Section3_Internet = () => {
  return (
    <div className="space-y-12 mt-32 prose prose-blue prose-lg text-gray-300 mx-auto max-w-4xl">
      ...
      <blockquote>
        <p>
          This prevents people from sharing information about the gatherings and
          claims of abuse against authorities known for their repressive tactics
        ...
        <p>
          ...
          WhatsApp, Instagram and Telegram remained restricted by Etecsa&apos;s
          servers, according to monitoring site Netblocks.
        </p>
      </blockquote>
      ...
      {/* twitter here */}
      <TwitterTweetEmbed tweetId="1416533421422039040" placeholder="Loading" />
...
export default Section3_Internet
