...
const CubanGovernmentResponse = () => {
  return (
    <div className="bg-gray-800 px-4 md:px-1">
      <Layout>
        <div className="my-32 prose prose-red prose-lg text-gray-300 mx-auto max-w-4xl md:max-w-6xl">
          ...
          <p>
            ...
            , the actual president of Cuba, made a speech transmitted on
            national TV calling for repression of the protests and inciting
            national violence. In his own words, he said:
          </p>
          <blockquote>
            <p className="py-32">
          ...
          <span className="my-48 block text-3xl text-center leading-8 font-semibold tracking-tight text-gray-300 sm:text-4xl">
            The so called{" "}
            <span className="text-red-500 underline">revolutionaries</span> by
            the president are simply:
          </span>

          <div className="space-y-32">
            <div>
              <p>
                special military brigades known as black berets -boinas negras
                in spanish-
              </p>
              {/* boinas negras */}
              <img
          ...
          <blockquote className="py-12">
            <span className="text-gray-400">
              ...
              regime deployed the{" "}
              <span className="font-semibold text-yellow-400">PNR</span>, a
              police unit under the Cuban MININT, to suppress and attack
              protesters. Led by Director{" "}
              <span className="font-semibold text-yellow-400">CALLEJAS</span>{" "}
              and Deputy Director{" "}
              ...
              organize families of the imprisoned and disappeared. In Camagüey,
              a Catholic priest was beaten and arrested by the{" "}
              <span className="font-semibold text-yellow-400">PNR</span> while
              he was defending young protesters; officers of the
              <span className="font-semibold text-yellow-400">PNR</span> also
              beat a group of peaceful demonstrators, including several minors.
              Additionally, there have been several recorded instances in which
              the <span className="font-semibold text-yellow-400">PNR</span>{" "}
              used clubs to violently break up peaceful protests across Cuba.
            </span>
          </blockquote>
          ...
          <p className="py-12">
            ...
            catch them, they will think that they are making a video against the
            government.
          </p>
